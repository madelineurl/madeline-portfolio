...
const Shiftpitch = () => (
  <Layout>
    ...
    <div className='container'>
      ...
      <div>
      <h3>technology</h3>
        <div className='project-blurb'>This was a solo exploration of the Howler.js audio library, built over four days during my time at Grace Hopper. I used React to write controlled front-end components that manipulated audio volume and pitch/speed rates in response to user input.</div>
        <h3>key takeaway</h3>
        <div className='project-blurb'>Pick the right tool for the job. This project required multiple audio sources being controlled <em>independently</em> of one another. I initially tried to build this tool using the Tone.js library, but soon realized that Tone lends itself more to creating sounds within a <em>single</em> timeline (i.e. music production).</div>
        <h3>up next</h3>
        <div className='project-blurb'>Implementing a way to measure success, and enabling players to log in and store data from various sessions in a database.</div>
      </div>
    </div>
  </Layout>
);
