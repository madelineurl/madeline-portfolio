...
const About = () => (
  <div className={styles.about}>
    ...
    <div>
      <div>I'm a nonbinary software engineer and radio host + DJ based in Chicago. I design accessible applications that help people connect to their creativity and to each other. </div>
      <div>
      ...
      <div>I'm currently a teaching fellow at the Grace Hopper program. When I'm not writing code, you can find me selling vinyl at <a href='https://www.gramaphonerecords.com/'>Gramaphone Records</a>, microsoldering analog synths, talking progressive politics, or boxing in the park.
      </div>
    </div>
  </div>
)
