...
const MusicBlurb = () => {
  return (
    <div className={styles.musicBlurb}>
      <div>I've been DJing for seven years; it's where my self-teaching journey began. I taught myself to DJ after getting involved with the radio station at Northwestern, and ended up working part-time as a freelance DJ and at
        <a
