  ...
  <div className={styles.container}>
    ...
    <div className={styles.testimonial} onClick={handleMatt}>
      ...
      <h4><em>Jet City Device Repair</em></h4>
        <div className={showMatt}>
          <div>Maddie is awesome. In case you don't have time to read the rest of this recommendation, let's get that out there right away. They are not just great at the work - though they were a spectacular repair technician - but also great with customers and an amazing coworker.</div>

          <div>Being a technician at our company isn't easy. There's the repair part of the job: troubleshooting broken devices, being able to fix dozens of different models, needing to figure out new models, etc. Being good at doing repairs is not simple but it's probably the easiest part of the job.</div>

          <div>Much harder is troubleshooting and helping people. While most of our customers are wonderful people and things usually go smoothly, that's not always the case. The sign of a great customer service person is not whether or not they can be great when things go well, it's how they respond when things go wrong. It is here that Maddie really differentiated themself.</div>

          <div>Patient and kind with customers (even when they weren't in return) and always willing to help - not just because it was their job but because they genuinely care about helping people.</div>
