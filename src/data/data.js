...
const ProjectData = {
  ...
  bread: {
    id: 'upper-crust',
    name: 'upper-crust',
    headerSentence: 'Bringing fresh-baked breads to the comfort of your home.',
    overview: 'A classic NERD stack e-commerce site built in a week by team of four. We practiced an agile methodology workflow while tackling the finer details of deployment, CI/CD via Travis, and authentication, and cementing our proficiency with our chosen stack.',
    ...
    takeaways: 'This project cemented my confidence in the NERD stack and ecommerce + security fundamentals. It was a great exercise in navigating group dynamics while collaborating on a shared codebase and delivering an MVP on schedule.',
    URLs: {
